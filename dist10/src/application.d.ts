...
declare const FamilyTreeApplication_base: (new (...args: any[]) => {
    ...
    boot(): Promise<void>;
    booters(...booterCls: import("@loopback/boot/node_modules/@loopback/context/dist8/src/value-promise").Constructor<import("@loopback/boot/dist8/src/interfaces").Booter>[]): import("@loopback/boot/node_modules/@loopback/context/dist8/src/binding").Binding<any>[];
    component(component: import("@loopback/boot/node_modules/@loopback/context/dist8/src/value-promise").Constructor<{}>): void;
    mountComponentBooters(component: import("@loopback/boot/node_modules/@loopback/context/dist8/src/value-promise").Constructor<{}>): void;
}) & (new (...args: any[]) => {
    [x: string]: any;
    serviceProvider<S>(provider: import("@loopback/service-proxy/dist8/src/mixins/service.mixin").Class<import("@loopback/boot/node_modules/@loopback/context/dist8/src/provider").Provider<S>>): void;
